...
<template>
  ...
  <section class="max-w-[1440px] mx-auto xl:px-[103px] px-[50px] max-sm:px-5">
    <div class="xxl:bg-dark xxl:rounded-[45px] xxl:p-[70px_60px_70px_60px]">
      <div
        class="flex max-[950px]:flex-col max-xl:gap-5 justify-between xxl:h-[186px] max-[950px]:items-center"
      >
        <Card
          class="max-xxl:bg-dark max-xxl:text-white max-xxl:rounded-[45px] max-xxl:px-[50px] max-xxl:py-[42px] max-xxl:w-[350px]"
